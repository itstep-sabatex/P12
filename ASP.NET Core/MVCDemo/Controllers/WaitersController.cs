...
namespace MVCDemo.Controllers
{
    public class WaitersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Password,Birthday")] Waiter waiter)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Password,Birthday")] Waiter waiter)
        {
            if (id != waiter.Id)
            {
                return NotFound();
